...
Object.defineProperty(exports, "__esModule", { value: true });
var d3_request_1 = __webpack_require__(/*! d3-request */ "./node_modules/d3-request/index.js");
var React = __webpack_require__(/*! react */ "react");
var react_1 = __webpack_require__(/*! react */ "react");
var src_1 = __webpack_require__(/*! ../src */ "./src/index.ts");
var MapExamples = function (_super) {
    __extends(MapExamples, _super);
    function MapExamples(props) {
        var _this = _super.call(this, props) || this;
        _this.state = {
            geojson: {},
            loading: true
    ...
    MapExamples.prototype.componentDidMount = function () {
        var _this = this;
        var url = 'https://opendata.arcgis.com/datasets/8d3a9e6e7bd445e2bdcc26cdf007eac7_3.geojson';
        d3_request_1.json(url, function (error, collection) {
            if (error) {
                throw error;
            }
            _this.setState({
    ...
    MapExamples.prototype.render = function () {
        if (this.state.loading) {
            return React.createElement("div", null, "loading");
        }
        var data = [];
        return React.createElement("div", null, React.createElement("h3", null, "Map"), React.createElement(src_1.Map, { data: data, geojson: this.state.geojson, height: 400, width: 400 }));
    };
    return MapExamples;
}(react_1.Component);
exports.default = MapExamples;
...
var PieExamples = function (_super) {
    ...
    PieExamples.prototype.toggleData = function () {
        this.setState({
    ...
    PieExamples.prototype.render = function () {
        ...
        var widths = ['100%', '100%'];
        var heights = [200, 100];
        return React.createElement("div", null, React.createElement("h3", null, "Pie Chart"), React.createElement(src_1.PieChart, { width: '100%', height: heights[dataIndex], donutWidth: 0, labels: {
                display: false,
                displayFn: function displayFn() {
                    return null;
                }
            }, data: toggleData[dataIndex] }), React.createElement("button", { onClick: function onClick() {
...
var react_1 = __webpack_require__(/*! react */ "react");
var ReactDOM = __webpack_require__(/*! react-dom */ "react-dom");
var HistogramD3_1 = __webpack_require__(/*! ./HistogramD3 */ "./src/HistogramD3.ts");
...
exports.histogramD3 = function () {
    ...
    var HistogramD3 = {
        ...
        barMargin: function barMargin() {
            var m = get(this.props.bar, 'margin', 0);
            return m >= 0 && m <= 1 ? m : 0.1;
        },
...
var react_1 = __webpack_require__(/*! react */ "react");
var ReactDOM = __webpack_require__(/*! react-dom */ "react-dom");
var HorizontalHistogramD3_1 = __webpack_require__(/*! ./HorizontalHistogramD3 */ "./src/HorizontalHistogramD3.ts");
var HorizontalHistogram = function (_super) {
    __extends(HorizontalHistogram, _super);
    function HorizontalHistogram(props) {
        var _this = _super.call(this, props) || this;
        _this.histogram = HorizontalHistogramD3_1.horizontalHistogramD3();
        _this.state = {
            parentWidth: 300
        };
        return _this;
    ...
    HorizontalHistogram.prototype.componentDidUpdate = function () {
        this.histogram.update(this.getDOMNode(), this.getChartState());
    };
    HorizontalHistogram.prototype.getChartState = function () {
        var width = this.props.width;
        var _a = this.props,
            children = _a.children,
            rest = __rest(_a, ["children"]);
    ...
    HorizontalHistogram.prototype.componentWillReceiveProps = function (props) {
        this.histogram.update(this.getDOMNode(), this.getChartState());
    };
    HorizontalHistogram.prototype.componentWillUnmount = function () {
        if (this.props.width === '100%') {
            window.removeEventListener('resize', this.handleResize);
        }
        this.histogram.destroy(this.getDOMNode());
    };
    HorizontalHistogram.prototype.getDOMNode = function () {
        return ReactDOM.findDOMNode(this.ref);
    };
    HorizontalHistogram.prototype.render = function () {
        var _this = this;
        return React.createElement("div", { ref: function ref(_ref) {
                return _this.ref = _ref;
            }, className: "histogram-chart-container" });
    };
    HorizontalHistogram.defaultProps = {
        axis: {},
        bar: {
            margin: 2,
            width: 10
        ...
        stroke: {
            color: function color(d, i, colors) {
                return d3_color_1.rgb(colors(i)).darker(1);
            },
            width: 1
        },
        tipContentFn: function tipContentFn(bins, i, d) {
...
exports.default = HorizontalHistogram;

/***/ }),

/***/ "./src/HorizontalHistogramD3.ts":
/*!**************************************!*\
  !*** ./src/HorizontalHistogramD3.ts ***!
  \**************************************/
/*! no static exports found */
...
exports.horizontalHistogramD3 = function () {
    ...
    var HorizontalHistogramD3 = {
        ...
        _drawScales: function _drawScales(data) {
            ...
            xAxis = d3_axis_1.axisBottom(x).ticks(axis.x.ticks);
            yAxis = d3_axis_1.axisLeft(y).ticks(axis.y.ticks);
            if (h / valuesCount < 10) {
                xAxis.tickValues(x.domain().filter(function (d, i) {
                    return !(i % 10);
                }));
            }
            xDomain = d3_array_1.extent(allCounts, function (d) {
                return d;
            });
            xDomain[0] = 0;
        ...
        barHeight: function barHeight() {
            ...
            var barHeight = h / valuesCount - bar.margin * 2 - this.groupedMargin();
            if (barHeight < 5) {
                bar.margin = 1;
                barHeight = Math.max(1, (h - (valuesCount + 1) * bar.margin) / valuesCount);
            }
        ...
        drawDataSet: function drawDataSet(bins, set, setIndex, setCount) {
            ...
            var colors = d3_scale_1.scaleOrdinal(set.colors || this.props.colorScheme);
            var borderColors = set.borderColors ? d3_scale_1.scaleOrdinal(set.borderColors) : null;
            var selector = '.bar-' + setIndex;
            var multiLineOffset = function multiLineOffset(index) {
                return setCount === 1 ? 0 : (index + setIndex) * (barHeight + _this.groupedMargin());
            };
            svg.selectAll(selector).remove();
            barItem = svg.selectAll(selector).data(set.data).enter().append('rect').attr('class', 'bar ' + selector).attr('y', function (d, index, all) {
                return bar.margin + (barHeight + bar.margin * 2) * index + multiLineOffset(index);
            }).attr('height', function (d) {
                return barHeight;
            }).attr('fill', function (d, i) {
                return colors(i);
                ...
                return axis.y.width + axis.y.style['stroke-width'];
            }).attr('width', 0);
            ...
            barItem.transition().duration(duration).delay(delay).attr('stroke-dasharray', function (d) {
                var currentWidth = x(d);
...
exports.joyPlotD3 = function () {
    ...
    var JoyPlotD3 = {
        ...
        groupedMargin: function groupedMargin() {
            var m = get(props.bar, 'groupMargin', 0.1);
            return m >= 0 && m <= 1 ? m : 0;
        },
        barMargin: function barMargin() {
            var m = get(props.bar, 'margin', 0);
            return m >= 0 && m <= 1 ? m : 0.1;
        },
        barWidth: function barWidth() {
            return innerScaleBand.bandwidth();
...
var Legend = function Legend(_a) {
    var className = _a.className,
        ...
        visible = _a.visible;
    var scheme = d3_scale_1.scaleOrdinal(theme);
...
var react_1 = __webpack_require__(/*! react */ "react");
var ReactDOM = __webpack_require__(/*! react-dom */ "react-dom");
var MapD3_1 = __webpack_require__(/*! ./MapD3 */ "./src/MapD3.ts");
var Map = function (_super) {
    __extends(Map, _super);
    function Map(props) {
        var _this = _super.call(this, props) || this;
        _this.chart = MapD3_1.mapD3();
        _this.state = {
            parentWidth: 300
        };
        return _this;
    }
    Map.prototype.handleResize = function () {
        var _this = this;
        var elem = this.getDOMNode();
        var width = this.ref.offsetWidth ? this.ref.offsetWidth : 0;
        this.setState({
    ...
    Map.prototype.getChartState = function () {
        var width = this.props.width;
        var _a = this.props,
            children = _a.children,
            rest = __rest(_a, ["children"]);
    ...
    Map.prototype.getDOMNode = function () {
        return ReactDOM.findDOMNode(this.ref);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var d3_geo_1 = __webpack_require__(/*! d3-geo */ "./node_modules/d3-geo/index.js");
var d3_selection_1 = __webpack_require__(/*! d3-selection */ "./node_modules/d3-selection/index.js");
var deepmerge_1 = __webpack_require__(/*! deepmerge */ "./node_modules/deepmerge/dist/es.js");
exports.mapD3 = function () {
    var svg;
    var defaultProps = {
        className: 'map-d3',
        data: [],
    ...
    var MapD3 = {
        ...
        _makeSvg: function _makeSvg(el) {
            ...
            var _a = this.props,
                ...
                height = _a.height,
                className = _a.className;
            svg = d3_selection_1.select(el).append('svg').attr('class', className).attr('width', width).attr('height', height).attr('viewBox', "0 0 " + width + " " + height).append('g');
        },
        updateChart: function updateChart(data, geojson) {
            var _a = this.props,
                width = _a.width,
                height = _a.height;
            var zoom = 3;
...
var react_1 = __webpack_require__(/*! react */ "react");
var ReactDOM = __webpack_require__(/*! react-dom */ "react-dom");
var PieChartD3_1 = __webpack_require__(/*! ./PieChartD3 */ "./src/PieChartD3.ts");
var PieChart = function (_super) {
    __extends(PieChart, _super);
    function PieChart(props) {
        var _this = _super.call(this, props) || this;
        _this.chart = PieChartD3_1.pieChartD3();
        _this.state = {
            parentWidth: 300
        };
        return _this;
    ...
    PieChart.prototype.getChartState = function () {
        var width = this.props.width;
        var _a = this.props,
            children = _a.children,
            rest = __rest(_a, ["children"]);
    ...
    PieChart.prototype.getDOMNode = function () {
        return ReactDOM.findDOMNode(this.ref);
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var d3_interpolate_1 = __webpack_require__(/*! d3-interpolate */ "./node_modules/d3-interpolate/index.js");
var d3_scale_1 = __webpack_require__(/*! d3-scale */ "./node_modules/d3-scale/index.js");
var d3_selection_1 = __webpack_require__(/*! d3-selection */ "./node_modules/d3-selection/index.js");
var d3_shape_1 = __webpack_require__(/*! d3-shape */ "./node_modules/d3-shape/index.js");
...
exports.pieChartD3 = function () {
    ...
    var defaultProps = {
        ...
        labels: {
            display: true,
            displayFn: function displayFn(d, ix) {
                return d.value;
            }
        },
        margin: {
    ...
    var PieChartD3 = {
        ...
        drawCharts: function drawCharts() {
            ...
            this.dataSets.forEach(function (dataSet, i) {
                var theme = get(data.counts[i], 'colors', _this.props.colorScheme);
        ...
        drawChart: function drawChart(data, i, bins, theme) {
            ...
            var outerRadius = this.outerRadius(i);
            var innerRadius = this.innerRadius(i);
            var thisPie = d3_shape_1.pie().sort(null).value(function (d) {
                return d.count;
            });
            ...
            path.merge(path).on('mouseover', function (d, ix) {
                tipContent.html(function () {
                    return tipContentFn(bins, ix, d.data.count, d.data.groupLabel);
                });
                tip.fx.in(tipContainer);
                ...
                return tip.fx.out(tipContainer);
            }).transition().delay(400).duration(500).attr('fill', function (d, j) {
                return colors(j);
...
var react_1 = __webpack_require__(/*! react */ "react");
var ReactDOM = __webpack_require__(/*! react-dom */ "react-dom");
var ScatterPlotD3_1 = __webpack_require__(/*! ./ScatterPlotD3 */ "./src/ScatterPlotD3.ts");
var ScatterPlot = function (_super) {
    ...
    ScatterPlot.prototype.render = function () {
        ...
        return React.createElement("div", { ref: function ref(_ref) {
                return _this.ref = _ref;
            }, className: "scatterplot-chart-container" });
    };
    ...
    var GenerateChart = {
        ...
        _makeSvg: function _makeSvg(el, data) {
            ...
            var _a = this.props,
                ...
                legendWidth = _a.legendWidth,
                padding = _a.padding;
            svg = d3_selection_1.select(el).append('svg').attr('class', className).attr('width', width + padding + legendWidth).attr('height', height + padding).append('g').attr('transform', 'translate(' + padding + ',' + padding / 2 + ')');
            color = d3_scale_1.scaleOrdinal(this.props.colorScheme);
        },
        _drawScales: function _drawScales(data) {
            var _a = this.props,
                height = _a.height,
            ...
            svg.selectAll('.x.axis').data(data).enter().append('g').attr('class', 'x axis').attr('transform', function (d, i) {
                ...
                d3_selection_1.select(this).call(xAxis);
            });
            svg.selectAll('.y.axis').data(data).enter().append('g').attr('class', 'y axis').attr('transform', function (d, i) {
                ...
                d3_selection_1.select(this).call(yAxis);
            });
        },
        _drawLegend: function _drawLegend() {
            ...
            legend.selectAll('.legendItem').data(choices).enter().append('g').each(function (c, i) {
                var cell = d3_selection_1.select(this);
        ...
        update: function update(el, props) {
            ...
            traits.forEach(function (trait) {
                domainByTrait[trait] = d3_array_1.extent(data.values, function (d) {
                    return d[trait];
                });
            });
            xAxis = d3_axis_1.axisBottom(xScale).ticks(6).tickSize(xSize * n);
            yAxis = d3_axis_1.axisLeft(yScale).ticks(6).tickSize(-ySize * n);
...
exports.default = function (colors) {
    return colors.filter(function (value) {
        try {
            var c = Color(value);
            var hsl = c.hsl().array();
            if (hsl.length > 3) {
            ...
            var luminosity = c.luminosity();
            return luminosity < 0.8 && luminosity > 0.1 && hsl[2] < 200 && hsl[2] > 20;
        } catch (e) {
            return false;
        }
...
exports.default = ['#4bbcad', '#d54539', '#5ab94d', '#8a5cd3', '#a4b243', '#ba5ccd', '#54995c', '#cf47a1', '#d29f3e', '#5c6fda', '#c36528', '#5fa6dc', '#d74770', '#7d7430', '#8a529e', '#df9273', '#5f74b8', '#ac5450', '#d192d7', '#b26088'];
...
Object.defineProperty(exports, "__esModule", { value: true });
var filterRange_1 = __webpack_require__(/*! ./colors/filterRange */ "./src/colors/filterRange.ts");
exports.filterRange = filterRange_1.default;
var Histogram_1 = __webpack_require__(/*! ./Histogram */ "./src/Histogram.tsx");
...
exports.default = {
    fx: {
        in: function _in(container) {
            container.style('left', d3_selection_1.event.pageX + 'px').style('top', d3_selection_1.event.pageY - 55 + 'px');
...
/***/ 0:
/*!*************************************!*\
  !*** multi ./examples/examples.tsx ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./examples/examples.tsx */"./examples/examples.tsx");
